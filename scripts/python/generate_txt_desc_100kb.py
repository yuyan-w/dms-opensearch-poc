...
# ========================================
# ■ 概要
# - 実行ディレクトリ配下に desc_100kb/ ディレクトリを作成し、
#   約100KBの日本語テキストファイルを10個生成するスクリプト
# - DMS / OpenSearch 検証用の description サンプルデータ作成を目的とする
#
# ■ 実行方法
# python generate_txt_desc_100kb.py
#
# ■ 実行結果
# - desc_100kb/ が存在しない場合は自動作成される
# - 以下のようなファイルが10個生成される
#   - desc_100kb/desc_ja_100kb_1.txt
#   - desc_100kb/desc_ja_100kb_2.txt
#   - ...
#   - desc_100kb/desc_ja_100kb_10.txt
#
# ■ 生成データの内容
# - 日本語の商品説明風テキストをランダム生成する
# - 文の組み合わせ、段落数、改行、箇条書きがランダムに変化する
# - 1ファイルあたりおおよそ100KB前後のサイズになる想定
#   （厳密に100KBぴったりではない）
#
# ■ 補足
...
for i in range(1, 11):
    text = generate_text()
    filepath = os.path.join(output_dir, f"desc_ja_100kb_{i}.txt")
